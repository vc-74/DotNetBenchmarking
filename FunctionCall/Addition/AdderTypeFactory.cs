...
/// </summary>
public static class AdderTypeFactory
{
    ...
    public static TakesTwoIntsReturnsInt BuildTypeIL(bool buildModule, DelegateType delegateType)
    {
        _builtMethodCount++;
        ...
        {
            typeName = $"Adder{_builtMethodCount}";
    ...
    private static Type[] _inputParameterTypes = new[] { typeof(int), typeof(int) };
}
